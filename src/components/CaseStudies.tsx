...
const caseStudies = [
  ...
  },
  {
    ...
    description:
        "Spearheaded the launch of 'Online Courses' as a core feature, leveraging UX design and advanced frontend capabilities to enhance user engagement and drive a 25% increase in client acquisition.",
    impact: "25% increase in client acquisition",
    image:
        'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40auto=format&fit=crop&w=800&q=80'
    }
];
