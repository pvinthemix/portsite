      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 mb-12">
            ...
            <p className="text-lg text-gray-600">
              With a background in both product management and software engineering, I have led the development of AI-powered tools, front-end revamps, and enterprise SaaS solutions. This portfolio provides an overview of key product initiatives, the impact they have driven, and the strategic vision behind them.
            </p>
          </div>
